...
# High Need: By country


## Col1 actual value

```{r dataviz_highneed_value_country}
#| output: true
...
#  geom_bar_interactive(aes(tooltip = (percent*100)), # tooltip for ggiraph
  ...
  scale_fill_brewer(palette = "YlGnBu") +
  labs(
    title = "Funding landscape for the next 4 quarters",
    subtitle = "",
...
```{r dataviz_highneed_percent_country}
#| output: true
